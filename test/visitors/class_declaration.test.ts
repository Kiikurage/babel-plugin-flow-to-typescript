...
pluginTester({
  ...
  constructor() {}
        ...
        // todo: maybe remove not needed parentheses
        output: 'class C extends React.Component<string | undefined | null, (string | boolean) | undefined | null> {}',
    }, {
        title: 'Class declaration types are transformed',
        code: `class C implements Something<?string, ?(string | boolean)> {}`,
        // todo: maybe remove not needed parentheses
        output: 'class C implements Something<string | undefined | null, (string | boolean) | undefined | null> {}',
    }]
});
