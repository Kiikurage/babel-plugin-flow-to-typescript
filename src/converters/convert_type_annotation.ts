...
import {tsTypeAnnotation, tsTypeAliasDeclaration, TSTypeAnnotation, TSTypeAliasDeclaration, TypeAnnotation, TypeAlias} from '@babel/types';
...
export function convertTypeAlias(path: NodePath<TypeAlias>): TSTypeAliasDeclaration {
    ...
    return tsTypeAliasDeclaration(
        path.node.id,
        typeParameters.isTypeParameterDeclaration() ? convertTypeParameterDeclaration(typeParameters) : null,
